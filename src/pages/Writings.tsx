  ...
  return (
    <div>
      ...
      <div className="m-2">
        ...
        <div className="text-xl mb-5 m-2">
          <p className="mb-5">Asymptotes: On Closeness is a mixed-genre collection of stories on human (and non-human) relationships. 
            At times goofy, and other times sincere, it wrestles with what it means to long for and feel love.
          </p>
          <p>From examinations on romantic love and self-acceptance, forgiveness and transient interactions at a Manhattan hotel, 
            Asymptotes aims to tell stories that reveal how intimacy manifests itself through experience and imagination, 
            and how language ultimately falls shorts in expressing how we really feel. Even though we all try anyway.
          </p>
        </div>
        {/* <div>
          <Link to="https://bottlecap.press/products/asymptotes" className=' md:block md:order-2 md:w-1/2 hidden'>
            <img src="/images/asymptotes.webp" className='w-[1/2]'/>
          </Link>
        </div> */}
      ...
      <Link to="https://bottlecap.press/products/asymptotes">
            <h1 className='text-2xl bg-white text-black text-center font-vcr mb-20'>BUY IT</h1>
      </Link>
    </div>
  )
}
